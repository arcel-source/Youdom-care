...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      {/* HERO */}
      <section className="relative pt-12 sm:pt-16 md:pt-20 pb-12 sm:pb-16 md:pb-20 bg-gradient-to-br from-primary-dark via-primary to-primary-light overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
              <a href="/contact" className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-secondary hover:bg-secondary-light text-primary font-bold rounded-xl transition-all text-base sm:text-lg min-h-[44px] text-center">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div key={idx} className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-100 hover:shadow-lg transition-shadow">
                <div className="text-4xl sm:text-5xl mb-3 sm:mb-4">{item.icon}</div>
                <h3 className="text-lg sm:text-xl font-bold text-text mb-2 sm:mb-3">{item.title}</h3>
                <p className="text-text-light text-sm sm:text-base">{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <Link key={idx} href={`/services/${service.slug}`} className="group">
                <div className="bg-warm p-6 sm:p-8 rounded-2xl border border-gray-200 hover:border-primary hover:shadow-lg transition-all h-full">
                  <div className="text-4xl sm:text-5xl mb-3 sm:mb-4 group-hover:scale-110 transition-transform">{service.icon}</div>
                  <h3 className="text-lg sm:text-xl font-bold text-text mb-2 sm:mb-3 group-hover:text-primary transition-colors">{service.title}</h3>
                  <p className="text-text-light text-sm">{service.desc}</p>
                  <div className="mt-3 sm:mt-4 text-primary font-bold text-sm group-hover:translate-x-2 transition-transform">
                    En savoir plus →
                  </div>
                </div>
              </Link>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            {[
              ...
              <div key={idx} className="bg-white p-6 sm:p-8 rounded-2xl border border-gray-200">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-6">
            {[
              ...
              <div key={idx} className="relative">
                <div className="bg-warm p-6 sm:p-8 rounded-2xl text-center">
                  <div className="absolute -top-4 left-4 sm:-top-6 sm:-left-2 h-10 w-10 sm:h-12 sm:w-12 rounded-full bg-secondary text-primary font-bold flex items-center justify-center text-base sm:text-lg">
                    {item.step}
                  </div>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-primary to-primary-light">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
            <a href="/contact" className="w-full sm:w-auto px-6 sm:px-8 py-3 sm:py-4 bg-secondary hover:bg-secondary-light text-primary font-bold rounded-xl text-base sm:text-lg min-h-[44px] text-center">
              Demander un devis gratuit
            </a>
