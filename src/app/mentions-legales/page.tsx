  ...
  return (
    <div className="min-h-screen pt-32 pb-16 bg-warm">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-text mb-8">Mentions Légales</h1>
        
        <div className="bg-white rounded-2xl p-8 shadow-sm space-y-6">
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">Informations sur l'entreprise</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">Responsabilité du site</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">Données personnelles</h2>
            <p className="text-text-light leading-relaxed">
