  ...
  return (
    <div className="min-h-screen pt-32 pb-16 bg-warm">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-text mb-8">Conditions Générales d'Utilisation</h1>
        
        <div className="bg-white rounded-2xl p-8 shadow-sm space-y-6">
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">Acceptation des conditions</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">Services proposés</h2>
            <p className="text-text-light leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">Responsabilité du client</h2>
            <p className="text-text-light leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">Annulation et résiliation</h2>
            <p className="text-text-light leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">Confidentialité</h2>
            <p className="text-text-light leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">Assurance</h2>
            <p className="text-text-light leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">Droit applicable</h2>
            <p className="text-text-light leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-bold text-primary mb-4">Modification des conditions</h2>
            <p className="text-text-light leading-relaxed">
