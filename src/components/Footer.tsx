        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link href="/services#aide-autonomie" className="text-white/70 hover:text-secondary transition-colors text-sm">Aide à l'autonomie</Link></li>
              ...
              <li><Link href="/services#aide-handicap" className="text-white/70 hover:text-secondary transition-colors text-sm">Aide au handicap</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-white/70">
              ...
              <li className="flex items-center gap-2">
                <span>📞</span>
                <a href="tel:+33184807297" className="hover:text-secondary">01 84 80 72 97</a>
              </li>
              <li className="flex items-center gap-2">
                <span>📱</span>
                <a href="tel:+33667224507" className="hover:text-secondary">06 67 22 45 07</a>
              </li>
              <li className="flex items-center gap-2">
                <span>✉️</span>
                <a href="mailto:contact@youdom-care.com" className="hover:text-secondary">contact@youdom-care.com</a>
              </li>
            </ul>
          </div>
        </div>
